 ...
 *
 */
public class DMASExploringState implements State<Object, DMASExplorationAntContext>{
	...
	public Object handle(Object event, DMASExplorationAntContext context) {
		if (ExploreService.class.isInstance(event)) {
			...
			talker = context.getContext().actorOf(DMASTalkerAntActor.props(msg.getServiceType(),
