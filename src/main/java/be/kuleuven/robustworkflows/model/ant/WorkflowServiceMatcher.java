...
//	 * Currently it uses the ServiceRequestExplorationReply.ServiceType to match which task is it...
//	 * 
//	 * @param agent
//	 * @param qos
//	 */
...
//	
//	/**
//	 * Returns the RAW representation (the graph representing) this workflow
//	 * @return
//	 */
